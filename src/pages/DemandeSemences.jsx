...
function DemandeSemences() {
  ...
  const data_ar =
  {
    ...
    data: `<h1 className="mb-3"> كيفية الحصول على البذور الرعوية و العلفية </h1>
    <br>
    <h4 className="mb-3">شروط عامة</h4>
    <ul>
        <li><strong>1. </strong>  وجود برنامج الزراعات الرعوية و العلفية ضمن عقد برنامج العمل المنبثق عن مخطط التنميةالتشاركي للعمادة المعنية.</li>
        <li><strong>2. </strong>يكون المنتفع من متساكني مناطق تدخل الديوان وتابع للجنة أو مجمع التنمية المعنية.</li>
        <li><strong>3. </strong>له مستغلة فلاحية توجد بها مساحة أرض صالحة لزراعة البذور الرعوية و العلفية.</li>
    </ul>

    <h4 className="mb-3">شروط خاصة</h4>
    <ul>
        <li><strong>1. </strong>الاتصال بلجنة أو مجمع التنمية للتسجيل بالقائمة الأولية للراغبين في الحصول على البذور الرعوية و العلفية(ماي - جوان)</li>
        <li><strong>2. </strong>  أثر ذلك تقع معاينة القطع المقترحة من طرف فنيي الديوان.(أوت)</li>
        <li><strong>3. </strong> ضبط قائمة المنتفعين الذين تتوفر فيهم الشروط. (أوت)</li>
        <li><strong>4. </strong>تحضير مهد البذر. (سبتمبر - أكتوبر) </li>
        <li><strong>5. </strong> معاينة تحضير مهد البذر من طرف فنيي الديوان.(سبتمبر - أكتوبر) </li>
        <li><strong>6. </strong>  تحديد القائمة النهائية للمنتفعين(سبتمبر - أكتوبر) </li>
        <li><strong>7. </strong> مساهمة المنتفع بنسبة 50% من سعر البذور الرعوية و العلفية والاستظهار بوصل إيداع المبلغ بالحساب البريدي للديوان (سبتمبر ) .</li>
        <li><strong>8. </strong> إمضاء التزام معرف به يتعهد من خلاله المنتفع بزراعة البذور الرعوية و العلفية وتطبيق التوصيات الفنية.(أكتوبر)</li>
        <li><strong>9. </strong>الحصول على كمية البذور المطلوبة.(أكتوبر) </li>
        <li><strong>10. </strong> معاينة عملية الزراعة.(نوفمبر)</li>
    </ul>
`
  ...
  const data_eng =
  {
    ...
    data: ` <h1 className="mb-3">How to Obtain Forage and pastoral Seeds</h1>
    <br>
    <h4 className="mb-3">General Conditions</h4>
    <ul>
        <li><strong>1. </strong>Having a seed planting program included in the  program contract stemming from the community development plan.</li>
        <li><strong>2. </strong>The beneficiary must be a resident of the intervention areas of the Office and belong to the relevant development committee or agriculture developement group.</li>
        <li><strong>3. </strong>Possess an agricultural exploitation with land suitable for Forage and pastoral Seeds.</li>
    </ul>

    <h4 className="mb-3">Specific Conditions</h4>
    <ul>
        <li><strong>1. </strong>Contact the committee or agricultural developement group to register on the preliminary list of applicants for forage and pastoral seeds.(May-June)</li>
        ...
        <li><strong>4. </strong>Prepare the seedbed.(September-October)</li>
        <li><strong>5. </strong>Inspection of the seedbed preparation by an Office technician.(September-October)</li>
        <li><strong>6. </strong>Determine the final list of beneficiaries.(September-October)</li>
        <li><strong>7. </strong>Beneficiary's contribution of 50% of  forage and pastoral seeds price and presentation of the payment receipt for this purpose.(September)</li>
        <li><strong>8. </strong>Sign a notarized commitment whereby the beneficiary undertakes to plant forage and pastoral seeds and follow the technical recommendations.(October)</li>
        <li><strong>9. </strong>Receive the required quantity of seeds.(October)</li>
        <li><strong>10. </strong>Supervision of the plot installation.(November)</li>
    </ul>
`
  }

  const data_fr = {
    data: `  <h1 className="mb-3">Comment obtenir des semences fourragères et pastorales</h1>
    <br>
    <h4 className="mb-3">Conditions générales</h4>
    <ul>
        <li><strong>1. </strong> Avoir un programme des cultures fourragères et pastorales inclus dans le contrat de programme découlant du plan de développement communautaire.</li>
        <li><strong>2. </strong>Le bénéficiaire doit être résident dans les zones d'intervention de l'Office et appartenir à un comité ou un groupement de développement agricole .</li>
        <li><strong>3. </strong>Posséder une exploitation agricole avec des terres appropriées pour les cultures fourragères et pastorales.</li>
    </ul>

    <h4 className="mb-3">Conditions spécifiques</h4>
    <ul>
        <li><strong>1. </strong>Contacter le comité ou le groupement de développement agricole pour s'inscrire sur la liste préliminaire des demandeurs de semences fourragères et pastorales.(Mai-Juin)</li>
        ...
        <li><strong>4. </strong>Préparer le lit de semence.(Septembre-Octobre)</li>
        <li><strong>5. </strong>Constatation de la préparation du lit de semence par les techniciens de l'Office.(Septembre-Octobre)</li>
        <li><strong>6. </strong>Déterminer la liste finale des bénéficiaires.(Septembre-Octobre)</li>
        <li><strong>7. </strong>Contribution du bénéficiaire (achat de semence à hauteur de 50% du prix d'achat) des semences fourragères et pastorales et présentation du reçu de versement du montant d'achat au compte postal de l'odesypano.(Septembre)</li>
        <li><strong>18. </strong>Signer un engagement notarié par lequel le bénéficiaire s'engage à planter les semences fourragères et pastorales et à appliquer les recommandations techniques.(Octobre)</li>
        <li><strong>9. </strong>Recevoir la quantité de semences requise.(Octobre)</li>
        <li><strong>10. </strong>Supervision de semi de l'installation des parcelles.(Novembre)</li>
    </ul>
  ...
  const data_cities_ar = [
    ...
    { "gouvernorat": "باجة", "delegation": "Tibar", "localite": "عين الدفالي" },
    { "gouvernorat": "باجة", "delegation": "Tibar", "localite": "دجبة" },
    ...
    { "gouvernorat": "الكاف", "delegation": "الكاف_Est", "localite": "Dyr El الكاف" },
    { "gouvernorat": "الكاف", "delegation": "الكاف_Est", "localite": "واد سواني" },
    { "gouvernorat": "الكاف", "delegation": "الكاف_Est", "localite": "واد سواني الجنوبية" },
    { "gouvernorat": "الكاف", "delegation": "الكاف_Est", "localite": "زعفران" },
    { "gouvernorat": "الكاف", "delegation": "الكاف_Ouest", "localite": "واد رمال الشمالية" },
    { "gouvernorat": "الكاف", "delegation": "الكاف_Ouest", "localite": "واد رمال الجنوبية" },
  ...
  const [culture_forgere, setCultureForgere] = useState("")
  ...
  const handlePrintDemande = () => {
    ...
    <div>
      <h1 style="text-align: center;">${t('dossier pour semences pastorales')}</h1>
      ...
      <div style="display: flex; flex-direction: column;">
        <div style="margin-bottom: 8px; font-size: 1.125rem; font-weight: 500; color: #4a4a4a;">
          ${t('culture forgére')}: ${culture_forgere}
        </div>
      </div>
    ...
    if (
      ...
      validateField(culture_forgere, 'culture_forgere') ||
  ...
  return (
    <>
      {show && <div style={{ zIndex: 999, backgroundColor: "whitesmoke", width: "100vw", position: "fixed", top: "40%", left: "50%", transform: "translate(-50%, -50%)", padding: "20px", boxShadow: "0 4px 8px rgba(0,0,0,0.1)", borderRadius: "5px" }}>
      ...
      <div className="p-4 space-y-4 border" dir={currentLanguage === "ar" ? "rtl" : "ltr"}>
        <h1 className='text-center'>{t('dossier pour semences pastorales')}</h1>
        <div className="flex flex-row align-items-center">
          <><label className="mb-2 text-lg font-medium text-gray-700">- {t("registrationCode")}</label>
            <label className="mb-2 mx-2 text-lg font-medium text-gray-700"> <span className='text-green-600 text-decoration-underline'>{demandeCode}</span>  </label>
          </>
          <div className='mx-5'>
        ...
        <div className="flex flex-col">
          <label className="mb-2 text-lg font-medium text-gray-700"> {t('culture forgére')}
          </label>
          <input
            className="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={culture_forgere}
            onChange={(e) => setCultureForgere(e.target.value)}
          />
          {validationErrors.culture_forgere && (
            <span style={{ color: "red" }}>{t('Ce champ est obligatoire')}</span>
          )}
        </div>
        ...
        <div className=" mt-4 col-6 flex flex-row justify-content-around">
          <button className='d-flex  align-items-center btn btn-primary' onClick={handlePrintDemande}>{t('Imprimer')} <FiPrinter className='mx-2' /></button>
        </div>
      </div>
...
export default DemandeSemences
